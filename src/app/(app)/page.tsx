    ...
    <div className="bg-background">
      ...
      <section className="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-4xl">
           <div className="mx-auto w-max mb-4 px-4 py-2 rounded-full bg-black/30 border border-primary/50"><span className="bg-gradient-to-r from-red-500 via-yellow-400 via-green-500 to-blue-500 bg-clip-text text-transparent text-lg font-semibold tracking-wider">Culture. Community. Connection.</span></div>
