    ...
    return (
        <div className="bg-background">
            <div className="container mx-auto px-4 py-12 md:py-20">
                ...
                <div className="my-12 md:my-16 relative aspect-video max-w-4xl mx-auto">
                     <Image 
                ...
                <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto my-16">
                    <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg border">
                     ...
                     <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg border">
                        ...
                        <h2 className="text-2xl font-headline font-semibold">Our Vision</h2>
                        <p className="mt-2 text-muted-foreground">
                        ...
                        {teamMembers.map((member) => (
                            <div key={member.name} className="flex flex-col items-center text-center p-6 bg-card rounded-lg border">
                                <Avatar className="w-24 h-24 mb-4">
                                    <AvatarImage src={member.avatar} alt={member.name} data-ai-hint={`${member.role}`} />
