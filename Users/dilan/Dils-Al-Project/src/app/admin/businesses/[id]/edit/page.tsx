...
import { Save, ArrowLeft, Building, Trash, Facebook, Instagram, X, Linkedin } from "lucide-react";
                        ...
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <FormField control={form.control} name="socials.x" render={({ field }) => (
                             ...
                             <FormField control={form.control} name="socials.linkedin" render={({ field }) => (
                                <FormItem><div className="relative"><Linkedin className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" /><FormControl><Input placeholder="LinkedIn URL" {...field} /></FormControl></div><FormMessage/></FormItem>
                            )} />
                        </CardContent>
                    </Card>
