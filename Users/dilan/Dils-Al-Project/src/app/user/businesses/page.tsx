    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create, edit, and manage all your business listings.
          </CardDescription>
        </CardHeader>
        <CardContent>
           {loading ? (
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem asChild>
                              <Link href={`/user/businesses/${business.id}/edit`} className="flex items-center gap-2 cursor-pointer"><Edit className="h-4 w-4" />Edit</Link>
                            </DropdownMenuItem>
                            <DropdownMenuItem asChild>
